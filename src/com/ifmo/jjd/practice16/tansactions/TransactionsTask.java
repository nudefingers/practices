...
public class TransactionsTask {
    public static void main(String[] args) {
        ...
        Map<String, Long> transactionSum = transactionStream
                .collect(Collectors.groupingBy(Transaction::getAccountNumber,
                        Collectors.summingLong(Transaction::getSum))); // можно ли в стриме сделать setBalance() ?

        System.out.println(transactionSum);


        // TODO: 2. найти сумму транзакций по каждому аккаунту
        Map<Account, Long> accountSum = transactionStream
